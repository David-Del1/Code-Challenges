import { howMuchPencil, listFoods, removeLastCharacters, totalSumCSV, wordsToCharList } from './array-methods';
...
test('It should return the name of ingredients', () => {
  expect(listFoods(gruffaloCrumble)).toStrictEqual(['Gruffalo', 'oats', 'brown sugar', 'flour', 'pure maple syrup', 'chopped nuts', 'baking soda', 'baking powder', 'cinnamon', 'melted butter', 'fresh water']);
});

test('It should return a string with last characters removed', () => {
